<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:68:"E:\job\template360\public/../application/admin\view\user\adduser.php";i:1531217595;s:63:"E:\job\template360\application\admin\view\public\layer_base.php";i:1531195274;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
...
//       title: '最终的提交信息'
//     })
	$.post("<?php echo url('adduser'); ?>",data.field,function(res){
		if(res.code == 1){
